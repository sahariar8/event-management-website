...
const Register = () => {
    ...
    return (
        <div>
        <div className="hero min-h-screen md:-mt-16 bg-base-200">
          <div className="md:w-1/4">
            <div className="text-center">
              <h1 className="text-2xl md:text-5xl font-bold text-emerald-400 mb-8">Registration Form</h1>
              ...
              <form className="card-body" onSubmit={handleRegistration}>
                ...
                <div className="form-control">
                  ...
                  <label className="label">
                    ...
                    <div>
                        <h1 className='label-text-alt md:text-sm font-semibold'>Already Have an Account? Please<Link to='/login' className='text-sm text-blue-600 font-semibold'> Login</Link></h1>
                    </div>
                  </label>
                </div>
